  ...
  <div>
    ...
    <i-row>
      ...
      <i-col i-class="color-col" span="12">
        <i-card i-class="color">
          <div slot="content">
            <div class="color-item light-primary">
      ...
      <i-col i-class="color-col" span="12">
        <i-card i-class="color">
          <div slot="content">
            <div class="color-item dark-primary">
    ...
    <i-row>
      ...
      <i-col i-class="color-col" span="12">
        <i-card i-class="color">
          <div slot="content">
            <div class="color-item sub-color">
      ...
      <i-col i-class="color-col" span="12">
        <i-card i-class="color">
          <div slot="content">
            <div class="color-item border dark">
      ...
      <i-col i-class="color-col" span="12">
        <i-card i-class="color">
          <div slot="content">
            <div class="color-item divider dark">
      ...
      <i-col i-class="color-col" span="12">
        <i-card i-class="color">
          <div slot="content">
            <div class="color-item background dark">
